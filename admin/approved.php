...
// Fetch only approved borrowed items, including quantity
$sql = "SELECT 
            bi.b_item_id, 
            le.item_name, 
...
<section class="flex">
    ...
    <main class="flex-1 min-h-screen p-8 ml-[272px] max-[1023px]:ml-[0px] overflow-scroll-y">
        ...
        <h2 class="text-2xl font-bold text-gray-700">Approved List</h2>
        <p class="mt-2 text-gray-600">View borrowed equipment details.</p>
            ...
            <table class="w-full min-w-[1200px]">
                <thead>
                    <tr>
                        ...
                        <th class="table-head">Date Approved</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-t">
                        ...
                        <td class="table-data"><?= date('F j, Y, g:i a', strtotime($item['date_approved'])); ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
