...
<?php
    ...
    if (!isset($_GET['token']) || empty($_GET['token'])) {
        header('Location: ' . $base_url . '/students/forgot-password.php?error=Invalid or missing token');
        exit();
    }
                ...
                <div class="w-[50%] justify-center flex min-[841px]items-center max-[840px]:bg-white max-[840px]:items-end ml-right z-1 !py-[75px] !pr-[100px] max-[1140px]:!pr-[50px] max-[840px]:!pr-[30px] max-[840px]:!pl-[30px] max-[840px]:!w-full">
                    <div class="flex flex-col justify-center gap-6 z-1 w-full">
                        <div class="flex flex-col gap-[30px]">
                            <img src="../assets/images/placeholder-logo.png" alt="Logo" class="w-[75px] h-[75px]">
                            ...
                            <p class="text-center neural-grotesk">Remembered your password? <a href="<?= $base_url ?>/students/sign-in" class="text-accent font-500">Sign In</a></p>
                        </div>
                    </div>
                </div>
